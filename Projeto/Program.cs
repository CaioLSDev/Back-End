...
pessoaJ01.cnpj = "13.666.420/0001-13";
...
System.Console.WriteLine("-----------------------------------");
System.Console.WriteLine($"O CNPJ da {pessoaJ01.nome} é { pessoaJ01.cnpj} / condição: {pessoaJ01.ValidarCnpj(pessoaJ01.cnpj)}");
...
//System.Console.WriteLine(pessoaJ01.ValidarCnpj("10345678910111"));

//System.Console.WriteLine(pessoaJ01.ValidarCnpj("13.666.420/0001-13"));
